...
import { createPollSchema, updatePollSchema, submitResponseSchema, claimPollSchema } from "@versus/shared";
...
router.patch("/:id", optionalAuth, validate(updatePollSchema), controller.updatePoll);
